...
src_url = 'https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBMDeveloperSkillsNetwork-PY0221EN-SkillsNetwork/labs/module%206/Lab%20-%20Extract%20Transform%20Load/data/source.zip'
src_path = f"{path}/source.zip"
...
log_file = "etl_code-log_file.txt"
target_file = "etl_code-transformed_data.csv"
